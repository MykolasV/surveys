...
module.exports = class PgPersistence {
  ...
  async existsSurveyTitle(title) {
    const FIND_SURVEY = "SELECT * FROM surveys WHERE title = $1";
  ...
  // Returns a Promise that resolves to `true` on success, `false` if the question
  // or the survey doesn't exist.
